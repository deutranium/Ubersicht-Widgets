...
const color = "#eee"; //set color for all calendar days
const todaysColor = "rgb(226, 43, 36)"; //set color for todays date
...
const Calendar = styled("div")`
	...
	grid-template-rows: 35px repeat(5, 39px);
`;

const Weekday = styled("div")`
	font-size: 12px;
	text-align: center;
	border-bottom: solid 1px rgb(226, 43, 36);
`;
